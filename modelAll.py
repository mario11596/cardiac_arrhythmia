...
# model based on MLP
def model_mlp():
    dataset_file = pd.read_csv(filepath_or_buffer=dataset_filepath, delimiter=',')
...
def model_decision_tree():
    ...
    roc_auc_value(probability_results, y_test)
    confusion_matrix_plot(confusion_matrix_values, 'decision-trees-all-dataset')
    return
...
def model_SVC():
    ...
    confusion_matrix_plot(confusion_matrix_values, 'svc-all-dataset')
    return
...
def model_knn():
    ...
    roc_auc_value(probalility_results, y_test)
    confusion_matrix_plot(confusion_matrix_values, 'knn-all-dataset')
    return
...
def model_random_forest():
    ...
    roc_auc_value(probalility_results, y_test)
    confusion_matrix_plot(confusion_matrix_values, 'random-forest-all-dataset')
